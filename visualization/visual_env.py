...
from utils import walk_paths, loaddata
...
def visual_env(df_kuaishou, df_taobao, save_fig_dir, savename):
    ...
    ax2 = plt.subplot(121)
    # ax1 = plt.gca()
    ax2.set_ylabel("Cumulative satisfaction", fontsize=11)
    ...
    ax1 = plt.subplot(122)
    # ax1 = plt.gca()
    ax1.set_ylabel("Cumulative satisfaction", fontsize=11)
    ...
    ax1.set_title("KuaiEnv", fontsize=11, y=1)
